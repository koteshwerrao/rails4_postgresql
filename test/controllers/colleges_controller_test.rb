...
class CollegesControllerTest < ActionController::TestCase
  ...
  test "should create college" do
    assert_difference('College.count') do
      post :create, college: { addres: @college.addres, city: @college.city, name: @college.name, state: @college.state }
    end
  ...
  test "should update college" do
    patch :update, id: @college, college: { addres: @college.addres, city: @college.city, name: @college.name, state: @college.state }
    assert_redirected_to college_path(assigns(:college))
  end
